...
export default function AvatarChat() {
    ...
    return (
        <div className="avatar-container">
            {/* 
               IMPORTANT: mountRef is always present now. 
               useAvatar will wait for config to arrive before loading 3D model.
            */}
            <div ref={mountRef} className="avatar-canvas" />

            {!config ? (
                <div className="loading-screen">
                    <p>Waking up the vampire...</p>
                </div>
            ) : (
                <div className="phone-frame">
                    ...
                    <div className="input-area">
                        <button onClick={toggleCallMode} className={`icon-btn ${isListening ? 'active' : ''}`}>
                            {isListening ? (
